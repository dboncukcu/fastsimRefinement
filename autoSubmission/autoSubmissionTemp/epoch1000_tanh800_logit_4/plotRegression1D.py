...
nameout = in_path + 'plots/'+ 'regression_1D_' + training_id + '_VARIABLE.png'
...
variables = [
    ...
    ('RecJet_btagDeepFlavCvL_logit', 'RecJet_btagDeepFlavCvL_CLASS', (60, -0.1, 1.1), 'RecJet_btagDeepFlavCvL_logit', 0.3, '1'),
        ('RecJet_btagDeepFlavQG_logit', 'RecJet_btagDeepFlavQG_CLASS', (60, -0.1, 1.1), 'RecJet_btagDeepFlavQG_logit', 0.3, '1'),
