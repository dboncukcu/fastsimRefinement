...
samples = [
    ('No MDMM, only MSE loss', _training_id , {}, '-.', 1.),
    ('No MDMM, only MMD loss', _training_id , {}, '-.', 1.),
    (r'MDMM, MSE + $\lambda$(0.0017 - MMD)', _training_id, {'mmdfixsigma_output_target': 0.0017}, '-', 0.7),
]

# specify the input and output
in_path = _in_path+_training_id +'_' + trainorval + '.csv'
print(in_path)
nameout = _in_path + 'plots/'+ 'pareto_' + samples[0][1] + '_' + trainorval + '.png'
if iszoom:
