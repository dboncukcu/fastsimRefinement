...
python train.py 2>&1 | tee traininglog_regression.txt
"""
...
in_path = '/eos/cms/store/group/comm_fastsim/RefinementTraining/T1ttttRun2_fromCMSSW_10_6_X/littletree_CMSSW_10_6_X_2023-04-23-0000_T1tttt_SMS-T1tttt_mGl-1500_mLSP-100_13TeV-pythia8_cfi_GEN_SIM_RECOBEFMIX_DIGI_L1_DIGI2RAW_L1Reco_RECO_PAT_NANO_coffea_new.root'
in_tree = 'tJet'
